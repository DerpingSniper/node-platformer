...
DECEL_LAND = .15; //solid-surface decelleration per speed unit per tick
DECEL_AIR = .3; //decelleration per speed unit per tick
...
ACCEL_JUMP = 1.75; //initial jump accel
DECEL_JUMP = .25; //deceleration per tick while jumping
